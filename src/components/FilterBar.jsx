...
function DistrictPanel({
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-3 bottom-3 z-50 max-h-[72vh] overflow-y-auto rounded-3xl border border-stone-200 bg-white p-3 shadow-2xl md:inset-x-auto md:bottom-auto md:left-1/2 md:top-28 md:w-[min(900px,calc(100vw-48px))] md:-translate-x-1/2">
