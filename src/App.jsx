    ...
    <main className="min-h-screen bg-stone-50 text-stone-950">
      <section className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-[1900px] px-4 py-3 sm:px-6 lg:px-8">
          <p className="mb-2 inline-flex rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-800">
            {copy.badge}
          </p>
      ...
      <section className="mx-auto max-w-[1900px] px-4 py-3 sm:px-6 lg:px-8">
